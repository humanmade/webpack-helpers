 ...
 * configuration default template below. The devConfig factory function accepts
...
const development = ( opts = {} ) => {
	// Clone the defaults object so the mutations below do not impact subsequent
	// configurations generated by this same method.
	const devDefaults = deepCopy( development.defaults );
 ...
 * configuration default template below. The prodConfig factory function takes
 * an overrides object which will be deeply merged into the default config.
 *
 * @param {Object} opts Configuration options to deeply merge into the defaults.
 * @returns {Object} A merged Webpack configuration object.
...
const production = ( opts = {} ) => {
	const prodDefaults = deepCopy( production.defaults );
